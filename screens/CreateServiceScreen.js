...
export default function CreateServiceScreen({ navigation }) {
  ...
  const themeColors = effectiveTheme === "dark"
    ? { background: "#121212", text: "#FFFFFF", primary: "#329de4", card: "#1F1F1F" }
    : { background: "#FFFFFF", text: "#000000", primary: "#329de4", card: "#F5F5F5" };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <TextInput
          style={[styles.input, { backgroundColor: themeColors.card, borderColor: themeColors.primary, color: themeColors.text }]}
        ...
        <TextInput
          style={[styles.input, { backgroundColor: themeColors.card, borderColor: themeColors.primary, color: themeColors.text, height: 120, textAlignVertical: "top" }]}
